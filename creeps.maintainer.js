var creepsMaintainer = {
    run: function() {
        ...
        if (builders.length < 4 && Game.spawns.Spawn1.canCreateCreep(standardBody) == OK) {
            var builderCreep = Game.spawns.Spawn1.createCreep(standardBody, undefined, {role: 'builder'});
        ...
        if (upgraders.length < 3 && Game.spawns.Spawn1.canCreateCreep(standardBody) == OK) {
            var upgraderCreep = Game.spawns.Spawn1.createCreep(standardBody, undefined, {role: 'upgrader'});
